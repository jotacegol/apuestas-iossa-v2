    ...
    async function checkAuthStatus() {
        try {
            ...
            if (data.authenticated) {
                ...
                authStatus.innerHTML = `<img src="https://cdn.discordapp.com/avatars/${currentUser.id}/${currentUser.avatar}.png?size=32" alt="Avatar"> ${currentUser.username}#${currentUser.discriminator}`;
                ...
                loadUserData(); // Load full user data including stats
            } else {
                currentUser = null;
                isAdmin = false;
